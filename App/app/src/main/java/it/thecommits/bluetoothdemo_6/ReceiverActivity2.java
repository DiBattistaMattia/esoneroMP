...
public class ReceiverActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvRecevedMessage = (TextView) findViewById(R.id.tvRecevedMessage);
    ...
    private void connectToDevice(BluetoothDevice device){
        mBluetoothConnection = new BluetoothConnectionService(ReceiverActivity2.this);
